...
test('route preventSameLocationChange', /*#__PURE__*/function () {
...
test('fixBrokenHistory', /*#__PURE__*/function () {
        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            r = new _Router.Router({
              '/': new _Page.Page(),
              '/user': new _Page.Page('user'),
              '/product': new _Page.Page('user')
            });
            r.start();
            r.pushPage('/user');
            r.pushPage('/product'); // Эмитируем открытие м закрытие левого приложения
...
test('popPageToAndReplace', /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(done) {
    var r;
