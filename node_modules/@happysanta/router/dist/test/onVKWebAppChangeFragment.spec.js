...
var _Router2 = require("../lib/entities/Router");
...
describe('onVKWebAppChangeFragment', function () {
  beforeEach(function () {
    window.history.replaceState({}, '', '/#');
  });
  it('after event isFirstPage is true', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              r = new _Router2.Router((_Router = {
                '/': new _Page.Page('main', 'main')
              }, _defineProperty(_Router, USER_PAGE, new _Page.Page('user', 'main')), _defineProperty(_Router, '/info', new _Page.Page('info', 'main')), _defineProperty(_Router, '/create', new _Page.Page('create', 'main')), _defineProperty(_Router, '/done', new _Page.Page('done', 'main')), _Router), null);
              r.start();
